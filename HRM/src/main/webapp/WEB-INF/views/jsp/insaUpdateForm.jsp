        ...
        >
          <div class="float-right">
            ...
            <button
              ...
              name="delEmp"
              id="delEmp"
              class="btn btn-sm btn-danger m-0 pl-4 pr-4"
            >삭제</button>
            <a
                  ...
                  <datalist id="mil_type_list">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '군별'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.mil_type}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
                  ...
                  <datalist id="kosa_reg_yn_list">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq 'KOSA등록'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.kosa_reg_yn}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
                  ...
                  <datalist id="gart_level_list">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '등급'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.gart_level}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
                  ...
                  <datalist id="mil_level_list">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '계급'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.mil_level}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
                  ...
                  <datalist id="kosa_class_code_list">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq 'KOSA등급'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.kosa_class_code}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
                  ...
                  <datalist id="domainList">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '이메일'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.domain}">selected</c:if>>
                  ...
                  <datalist id="dept_codeList">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '부서'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.dept_code}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
              ...
              <div class="col p-0">
                ...
                <div class="col-6 in-blk p-0">
                  <input
                    ...
                    class="w-100 small"
                    maxlength="14"
                    value="${PARAM.reg_no_input}"
                  />
                  <input type="hidden" name="reg_no" id="reg_no" value="${PARAM.reg_no}" />
                </div>
              </div>
              <div class="col p-0">
                <div class="col-3 in-blk p-0">
                  ...
                  <datalist id="join_gbn_codeList">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '직종'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.join_gbn_code}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
                  ...
                  <datalist id="sexList">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '성별'}">
                        <option value="${com.name}" <c:if test="${com.name eq PARAM.sex}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
              ...
              <div class="col p-0">
                ...
                <div class="col-4 in-blk p-0">
                  <input
                    ...
                    id="salary_input"
                    class="w-100 small text-right"
                    value="${PARAM.salary_input}"
				  />
				  <input type="hidden" name="salary" id="salary" value="${PARAM.salary}">
                </div>
                  ...
                  <datalist id="mil_ynList">
                    <c:forEach var="com" items="${COMLIST}">
                      <c:if test="${com.gubun eq '군필여부'}">
                        <option value="${com.name}"<c:if test="${com.name eq PARAM.mil_yn}">selected</c:if>>${com.name}</option>
                      </c:if>
                    </c:forEach>
                  </datalist>
                </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body div-in-modal center">
            <img class="img-frm dnone" id="preview_cmp_reg" src="/hrm/cmp_reg/${PARAM.cmp_reg_image}" />
            <img class="img-frm dnone" id="preview_carrier" src="/hrm/carrier/${PARAM.carrier}" />
          </div>
          <!-- Footer -->
